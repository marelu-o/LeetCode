...
public:
 ...
 /* Didática do código:
        ...
        #  if (nums.size() == 1) return nums[0]; -> Se o tamanho do vetor for igual à 1, retorna o único valor  presente no vetor.
        ...
        # for (int i = 2; i < nums.size(); i++) -> Inicia no segundo índice e vai adiante
        ...
        # return nums.back(); -> retorna o último valor presente na lista = nums[4] = 12
